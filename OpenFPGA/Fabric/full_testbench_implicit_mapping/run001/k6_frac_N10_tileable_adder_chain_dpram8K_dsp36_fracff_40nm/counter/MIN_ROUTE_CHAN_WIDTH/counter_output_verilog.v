...
module counter(clk, reset, result);
  ...
  wire _01_;
  (* force_downto = 32'd1 *)
  (* src = "./benchmark/counter.v:22.2-28.5|/home/ubuntu/Desktop/OpenFPGA/build/yosys/bin/../share/yosys/adff2dff.v:14.18-14.24" *)
  wire [7:0] _02_;
  ...
  (* src = "./benchmark/counter.v:22.2-28.5|/home/ubuntu/Desktop/OpenFPGA/build/yosys/bin/../share/yosys/adff2dff.v:25.3-26.16" *)
  always @(posedge clk)
    result[3] <= _02_[3];
  (* src = "./benchmark/counter.v:22.2-28.5|/home/ubuntu/Desktop/OpenFPGA/build/yosys/bin/../share/yosys/adff2dff.v:25.3-26.16" *)
  always @(posedge clk)
