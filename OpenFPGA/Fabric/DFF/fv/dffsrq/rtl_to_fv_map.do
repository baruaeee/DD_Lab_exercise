...
# Generated on: Tue Jun 17 00:38:31 CEST 2025 (Mon Jun 16 22:38:31 UTC 2025)
...
set logfile fv/dffsrq/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/dffsrq -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/bas33767/Desktop/DD_Lab_exercise/OpenFPGA/Fabric/DFF/LIB/sg13g2_stdcell_typ_1p50V_25C.lib
...
elaborate_design -golden -root {dffsrq} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/dffsrq/fv_map.v.gz
elaborate_design -revised -root {dffsrq}
...
set_analyze_option -mapping_file fv/dffsrq/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.dffsrq.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.dffsrq.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.dffsrq.rtl.fv_map.rpt
