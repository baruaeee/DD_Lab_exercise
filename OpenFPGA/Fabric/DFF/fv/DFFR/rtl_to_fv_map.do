...
# Generated on: Sun Jul 06 22:39:03 CEST 2025 (Sun Jul 06 20:39:03 UTC 2025)
...
set logfile fv/DFFR/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/DFFR -revised fv_map -use_rtl_names
...
elaborate_design -golden -root {DFFR} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/DFFR/fv_map.v.gz
elaborate_design -revised -root {DFFR}
...
set_analyze_option -mapping_file fv/DFFR/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.DFFR.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.DFFR.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.DFFR.rtl.fv_map.rpt
