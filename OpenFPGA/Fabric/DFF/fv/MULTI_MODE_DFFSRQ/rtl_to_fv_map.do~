...
# Generated on: Wed Jun 25 19:22:19 EDT 2025 (Wed Jun 25 23:22:19 UTC 2025)
...
set logfile fv/MULTI_MODE_DFFSRQ/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/MULTI_MODE_DFFSRQ -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k dff.v
elaborate_design -golden -root {MULTI_MODE_DFFSRQ} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/MULTI_MODE_DFFSRQ/fv_map.v.gz
elaborate_design -revised -root {MULTI_MODE_DFFSRQ}
...
set_analyze_option -mapping_file fv/MULTI_MODE_DFFSRQ/fv_map.map.do
...
write_compared_points noneq.compared_points.MULTI_MODE_DFFSRQ.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.MULTI_MODE_DFFSRQ.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.MULTI_MODE_DFFSRQ.rtl.fv_map.rpt
