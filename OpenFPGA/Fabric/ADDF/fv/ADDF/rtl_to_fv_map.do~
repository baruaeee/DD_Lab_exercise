...
# Generated on: Wed Jun 25 18:03:17 EDT 2025 (Wed Jun 25 22:03:17 UTC 2025)
...
set logfile fv/ADDF/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ADDF -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /run/media/exotic/Cadence/DD_Lab_exercise/OpenFPGA/Fabric/ADDF/LIB/sg13g2_stdcell_typ_1p20V_25C.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k adder.v
elaborate_design -golden -root {ADDF} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ADDF/fv_map.v.gz
elaborate_design -revised -root {ADDF}
...
set_analyze_option -mapping_file fv/ADDF/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.ADDF.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ADDF.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ADDF.rtl.fv_map.rpt
