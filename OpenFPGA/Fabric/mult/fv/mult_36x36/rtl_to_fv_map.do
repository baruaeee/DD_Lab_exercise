...
# Generated on: Wed Jun 25 16:04:59 EDT 2025 (Wed Jun 25 20:04:59 UTC 2025)
...
set logfile fv/mult_36x36/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mult_36x36 -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k mult_36x36.v
elaborate_design -golden -root {mult_36x36} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mult_36x36/fv_map.v.gz
elaborate_design -revised -root {mult_36x36}
...
set_analyze_option -mapping_file fv/mult_36x36/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mult_36x36.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mult_36x36.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mult_36x36.rtl.fv_map.rpt
