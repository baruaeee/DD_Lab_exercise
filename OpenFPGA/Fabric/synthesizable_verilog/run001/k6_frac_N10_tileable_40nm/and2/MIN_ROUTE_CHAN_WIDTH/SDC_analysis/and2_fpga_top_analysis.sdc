...
#	Date: Mon Jun 30 17:24:08 2025
#############################################

##################################################
# Create clock                                    
##################################################
create_clock clk[0] -period 6.666666663e-10 -waveform {0 3.333333332e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 6.666666663e-10 gfpga_pad_GPIO_PAD[22]
set_input_delay -clock clk[0] -max 6.666666663e-10 gfpga_pad_GPIO_PAD[26]
set_output_delay -clock clk[0] -max 6.666666663e-10 gfpga_pad_GPIO_PAD[9]
