...
# Generated on: Mon Jun 16 15:58:35 CEST 2025 (Mon Jun 16 13:58:35 UTC 2025)
...
set logfile fv/fpga_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fpga_top -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86"
set env(CW_DIR) "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/run/media/exotic/Cadence/Installed/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both \
    ...
    /run/media/exotic/Cadence/DD_Lab_exercise/OpenFPGA/Fabric/synthesizable_verilog/Synthesis/../../ihp-sg13g2/libs.ref/sg13g2_stdcell/lib/sg13g2_stdcell_typ_1p50V_25C.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k SRC/fabric_netlists.v
elaborate_design -golden -root {fpga_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fpga_top/fv_map.v.gz
elaborate_design -revised -root {fpga_top}
...
set_analyze_option -mapping_file fv/fpga_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.fpga_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fpga_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fpga_top.rtl.fv_map.rpt
