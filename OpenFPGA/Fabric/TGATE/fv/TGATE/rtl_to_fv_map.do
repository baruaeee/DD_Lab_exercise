...
# Generated on: Thu Jun 26 21:45:23 CEST 2025 (Thu Jun 26 19:45:23 UTC 2025)
...
set logfile fv/TGATE/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/TGATE -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/bas33767/Desktop/DD_Lab_exercise/OpenFPGA/Fabric/TGATE/LIB/sg13g2_stdcell_typ_1p20V_25C.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k TGATE.v
elaborate_design -golden -root {TGATE} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/TGATE/fv_map.v.gz
elaborate_design -revised -root {TGATE}
...
set_analyze_option -mapping_file fv/TGATE/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.TGATE.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.TGATE.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.TGATE.rtl.fv_map.rpt
