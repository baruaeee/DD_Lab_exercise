...
create_analysis_view -name Best_CASE -constraint_mode CONSTRAINTS -delay_corner MIN_DEALY -latency_file ${::IMEX::dataVar}/mmmc/views/Best_CASE/latency.sdc
create_analysis_view -name WORST_CASE -constraint_mode CONSTRAINTS -delay_corner MAX_DEALY -latency_file ${::IMEX::dataVar}/mmmc/views/WORST_CASE/latency.sdc
