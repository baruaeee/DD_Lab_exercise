...
# Created by Genus(TM) Synthesis Solution 23.11-s100_1 on Thu May 29 04:35:26 CEST 2025
...
set_db -quiet runtime_by_stage {{to_generic 1 10 0 8} {first_condense 0 10 0 8} {PBS_Generic_Opt-Post 1 10 0.9968019999999997 8.996798} {{PBS_Generic-Postgen HBO Optimizations} 0 10 0.0 8.996798} {PBS_TechMap-Start 0 10 0.0 8.996798} {{PBS_TechMap-Premap HBO Optimizations} 0 10 0.0 8.996798} {second_condense 0 11 0 9} {reify 0 11 0 9} {global_incr_map 0 11 0 9} {{PBS_Techmap-Global Mapping} 1 11 -0.0027159999999994966 8.994082} {{PBS_TechMap-Datapath Postmap Operations} 0 11 1.0 9.994082} {{PBS_TechMap-Postmap HBO Optimizations} 0 11 -0.00021599999999999397 9.993866} {{PBS_TechMap-Postmap Clock Gating} 0 11 0.0 9.993866} {{PBS_TechMap-Postmap Cleanup} 0 11 -0.00024800000000091416 9.993618} {PBS_Techmap-Post_MBCI 1 12 0.0 9.993618} {incr_opt 0 12 0 10} }
...
set_db -quiet flow_metrics_snapshot_uuid d0f9f997-ace3-462a-8647-2ab1e32ae91b
...
## Written on 04:35:26 29-May 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid d0f9f997-ace3-462a-8647-2ab1e32ae91b}
