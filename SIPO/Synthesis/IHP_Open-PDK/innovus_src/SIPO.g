...
# Created by Genus(TM) Synthesis Solution 23.11-s100_1 on Mon May 26 19:15:15 CEST 2025
...
set_db -quiet runtime_by_stage {{to_generic 1 10 0 8} {first_condense 0 10 0 8} {PBS_Generic_Opt-Post 1 10 0.9970369999999997 8.997034} {{PBS_Generic-Postgen HBO Optimizations} 0 10 0.0 8.997034} {PBS_TechMap-Start 0 10 0.0 8.997034} {{PBS_TechMap-Premap HBO Optimizations} 0 10 0.0 8.997034} {second_condense 0 10 0 8} {reify 0 10 0 8} {global_incr_map 1 11 0 9} {{PBS_Techmap-Global Mapping} 1 11 -0.001962999999999937 8.995071} {{PBS_TechMap-Datapath Postmap Operations} 0 11 0.0 8.995071} {{PBS_TechMap-Postmap HBO Optimizations} 0 11 0.9997190000000007 9.99479} {{PBS_TechMap-Postmap Clock Gating} 0 11 0.0 9.99479} {{PBS_TechMap-Postmap Cleanup} 0 11 -0.00021899999999952513 9.994571} {PBS_Techmap-Post_MBCI 0 11 0.0 9.994571} {incr_opt 0 12 0 10} }
...
set_db -quiet flow_metrics_snapshot_uuid a1d23911-6daa-4ddf-a463-775eb203e367
...
set_db -quiet design:serial_to_parallel .qos_by_stage {{to_generic {wns -145} {tns 1269} {vep 15} {area 326} {cell_count 9} {utilization  0.00} {runtime 1 10 0 8} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 326} {cell_count 9} {utilization  0.00} {runtime 0 10 0 8} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 326} {cell_count 9} {utilization  0.00} {runtime 0 10 0 8} }{reify {wns -21} {tns 57} {vep 8} {area 791} {cell_count 24} {utilization  0.00} {runtime 0 10 0 8} }{global_incr_map {wns -21} {tns 57} {vep 8} {area 791} {cell_count 24} {utilization  0.00} {runtime 1 11 0 9} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 887} {cell_count 24} {utilization  0.00} {runtime 0 12 0 10} }}
...
## Written on 19:15:15 26-May 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid a1d23911-6daa-4ddf-a463-775eb203e367}
