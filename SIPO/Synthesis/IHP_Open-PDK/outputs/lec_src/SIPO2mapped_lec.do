...
# Generated on: Thu May 29 04:35:25 CEST 2025 (Thu May 29 02:35:25 UTC 2025)
...
set logfile outputs/lec_src/SIPO2mapped_lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_SIPO2mapped_lecv_db

read_implementation_information fv/serial_to_parallel -golden fv_map -revised SIPO2mapped_lecv -use_rtl_names
...
read_design -verilog95   -revised -lastmod -noelab outputs/lec_src/SIPO2mapped_lec.v
elaborate_design -revised -root {serial_to_parallel}

write_design -golden fv_map_SIPO2mapped_lecv_db/elab.v -replace
report_design_data
report_black_box
report_modules
...
analyze_extended_mapping fv/serial_to_parallel/fv_map.map.do fv/serial_to_parallel/SIPO2mapped_lecv.map.do -output fv_map_SIPO2mapped_lecv_1.map.do -input_specification rtl-n1 rtl-n2 -output_specification n1-n2 -replace -verbose
...
set_analyze_option -mapping_file fv_map_SIPO2mapped_lecv_1.map.do
...
write_compared_points noneq.compared_points.serial_to_parallel.fv_map.SIPO2mapped_lecv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.serial_to_parallel.fv_map.SIPO2mapped_lecv.rpt
}
report_test_vector -noneq > noneq.test_vector.serial_to_parallel.fv_map.SIPO2mapped_lecv.rpt
