...
# Generated on: Mon May 26 19:15:15 CEST 2025 (Mon May 26 17:15:15 UTC 2025)
...
set logfile outputs/lec_src/SIPO2final_lec.log ;# user can modify this name for succeeding runs
...
set_verification_information rtl_SIPO_netlistv.1_db

read_implementation_information fv/serial_to_parallel -revised SIPO_netlistv.1 -use_rtl_names
...
write_design -golden rtl_SIPO_netlistv.1_db/elab.v -replace
...
set_analyze_option -mapping_file fv/serial_to_parallel/SIPO_netlistv.1.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.serial_to_parallel.rtl.SIPO_netlistv.1.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.serial_to_parallel.rtl.SIPO_netlistv.1.rpt
}
report_test_vector -noneq > noneq.test_vector.serial_to_parallel.rtl.SIPO_netlistv.1.rpt
