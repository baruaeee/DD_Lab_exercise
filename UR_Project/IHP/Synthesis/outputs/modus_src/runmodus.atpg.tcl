...
build_model \
    -cell	 Main \
    -techlib	 /eda/cadence/pdks/ihp_sg13g2/ixc013g2ng_stdcell/verilog/ixc013g2ng_stdcell.v \
    -designsource	 $WORKDIR/Main.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/Main.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
