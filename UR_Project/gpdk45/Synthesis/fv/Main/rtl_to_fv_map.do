...
# Generated on: Sun Aug 10 17:29:46 CEST 2025 (Sun Aug 10 15:29:46 UTC 2025)
...
set logfile fv/Main/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Main -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /eda/cadence/pdks/gpdk045/gsclib045_all_v4_4/gsclib045/timing/slow_vdd1v2_basicCells.lib \
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../RTL/ActivationMultiplier.sv ../RTL/Adder_6.sv ../RTL/adder_nbit.sv ../RTL/AND_6_MULT.sv ../RTL/Main.sv ../RTL/Out_Gen_Func.sv
elaborate_design -golden -root {Main} -rootonly -rootonly  
...
set_analyze_option -mapping_file fv/Main/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.Main.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Main.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Main.rtl.fv_map.rpt
