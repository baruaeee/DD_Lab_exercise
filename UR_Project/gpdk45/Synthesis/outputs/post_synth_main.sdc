...
create_clock -name "clk" -period 2.5 -waveform {0.0 1.0} [get_ports clk]
...
set_false_path -from [get_ports rst] -to [list \
  [get_cells OGF_R3_reg]  \
  [get_cells OGF_R2_reg]  \
  [get_cells OGF_R1_reg]  \
  [get_cells OGF_R0_reg]  \
  [get_cells {AT6_sum_out_reg[3]}]  \
  [get_cells {AT6_sum_out_reg[2]}]  \
  [get_cells {AT6_sum_out_reg[1]}]  \
  [get_cells {A6M_result_reg[2][0]}]  \
  [get_cells {A6M_result_reg[1][0]}]  \
  [get_cells {A6M_result_reg[2][3]}]  \
  [get_cells {A6M_result_reg[0][0]}]  \
  [get_cells {A6M_result_reg[5][0]}]  \
  [get_cells {A6M_result_reg[3][4]}]  \
  [get_cells {A6M_result_reg[4][2]}]  \
  [get_cells {A6M_result_reg[2][2]}]  \
  [get_cells {A6M_result_reg[1][1]}]  \
  [get_cells {A6M_result_reg[5][3]}]  \
  [get_cells {A6M_result_reg[3][2]}]  \
  [get_cells {A6M_result_reg[3][0]}]  \
  [get_cells {A6M_result_reg[4][0]}]  \
  [get_cells {A6M_result_reg[0][1]}]  \
  [get_cells {A6M_result_reg[0][2]}]  \
  [get_cells {A6M_result_reg[0][3]}]  \
  [get_cells {A6M_result_reg[1][2]}]  \
  [get_cells {A6M_result_reg[1][3]}]  \
  [get_cells {A6M_result_reg[2][1]}]  \
  [get_cells {A6M_result_reg[0][4]}]  \
  [get_cells {A6M_result_reg[4][1]}]  \
  [get_cells {A6M_result_reg[4][3]}]  \
  [get_cells {A6M_result_reg[5][1]}]  \
  [get_cells {A6M_result_reg[5][2]}]  \
  [get_cells {A6M_result_reg[3][3]}]  \
  [get_cells {A6M_result_reg[1][4]}]  \
  [get_cells {A6M_result_reg[2][4]}]  \
  [get_cells {A6M_result_reg[4][4]}]  \
  [get_cells {A6M_result_reg[5][4]}]  \
  [get_cells {A6M_result_reg[3][1]}]  \
  [get_cells {A6M_cycle_counter_reg[3]}]  \
  [get_cells {A6M_cycle_counter_reg[2]}]  \
  [get_cells {AT6_sum_out_reg[0]}]  \
  [get_cells A6M_en_reg]  \
  [get_cells {A6M_cycle_counter_reg[1]}]  \
  [get_cells {A6M_activation_reg_reg[4][2]}]  \
  [get_cells {A6M_activation_reg_reg[1][6]}]  \
  [get_cells {A6M_activation_reg_reg[4][5]}]  \
  [get_cells {A6M_activation_reg_reg[5][4]}]  \
  [get_cells {A6M_activation_reg_reg[2][6]}]  \
  [get_cells {A6M_activation_reg_reg[2][3]}]  \
  [get_cells {A6M_activation_reg_reg[5][2]}]  \
  [get_cells {A6M_activation_reg_reg[4][4]}]  \
  [get_cells {A6M_activation_reg_reg[0][2]}]  \
  [get_cells {A6M_activation_reg_reg[1][2]}]  \
  [get_cells {A6M_activation_reg_reg[3][0]}]  \
  [get_cells {A6M_activation_reg_reg[2][0]}]  \
  [get_cells {A6M_activation_reg_reg[1][7]}]  \
  [get_cells {A6M_activation_reg_reg[3][6]}]  \
  [get_cells {A6M_activation_reg_reg[3][2]}]  \
  [get_cells {A6M_activation_reg_reg[5][7]}]  \
  [get_cells {A6M_activation_reg_reg[2][7]}]  \
  [get_cells {A6M_activation_reg_reg[3][1]}]  \
  [get_cells {A6M_activation_reg_reg[3][3]}]  \
  [get_cells {A6M_activation_reg_reg[3][4]}]  \
  [get_cells {A6M_activation_reg_reg[3][5]}]  \
  [get_cells {A6M_activation_reg_reg[3][7]}]  \
  [get_cells {A6M_activation_reg_reg[0][1]}]  \
  [get_cells {A6M_activation_reg_reg[4][1]}]  \
  [get_cells {A6M_activation_reg_reg[5][6]}]  \
  [get_cells {A6M_activation_reg_reg[4][3]}]  \
  [get_cells {A6M_activation_reg_reg[1][4]}]  \
  [get_cells {A6M_activation_reg_reg[4][6]}]  \
  [get_cells {A6M_activation_reg_reg[4][7]}]  \
  [get_cells {A6M_activation_reg_reg[5][0]}]  \
  [get_cells {A6M_activation_reg_reg[5][1]}]  \
  [get_cells {A6M_activation_reg_reg[5][3]}]  \
  [get_cells {A6M_activation_reg_reg[5][5]}]  \
  [get_cells {A6M_activation_reg_reg[0][0]}]  \
  [get_cells {A6M_activation_reg_reg[1][5]}]  \
  [get_cells {A6M_activation_reg_reg[4][0]}]  \
  [get_cells {A6M_activation_reg_reg[0][3]}]  \
  [get_cells {A6M_activation_reg_reg[0][5]}]  \
  [get_cells {A6M_activation_reg_reg[0][6]}]  \
  [get_cells {A6M_activation_reg_reg[0][7]}]  \
  [get_cells {A6M_activation_reg_reg[2][5]}]  \
  [get_cells {A6M_activation_reg_reg[2][4]}]  \
  [get_cells {A6M_activation_reg_reg[2][2]}]  \
  [get_cells {A6M_activation_reg_reg[0][4]}]  \
  [get_cells {A6M_activation_reg_reg[2][1]}]  \
  [get_cells {A6M_activation_reg_reg[1][3]}]  \
  [get_cells {A6M_activation_reg_reg[1][1]}]  \
  [get_cells {A6M_activation_reg_reg[1][0]}]  \
  [get_cells {A6M_cycle_counter_reg[0]}] ]
