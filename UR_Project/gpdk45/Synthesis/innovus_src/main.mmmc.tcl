...
create_library_set -name default_emulate_libset_max \
    -timing { /eda/cadence/pdks/gpdk045/gsclib045_all_v4_4/gsclib045/timing/slow_vdd1v2_basicCells.lib \
              /eda/cadence/pdks/gpdk045/gsclib045_all_v4_4/gsclib045/timing/fast_vdd1v2_basicCells.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { innovus_src/main.default_emulate_constraint_mode.sdc }
