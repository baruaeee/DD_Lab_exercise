...
# Libraries
################################################################################
::legacy::set_attribute library {/eda/cadence/pdks/gpdk045/gsclib045_all_v4_4/gsclib045/timing/slow_vdd1v2_basicCells.lib /eda/cadence/pdks/gpdk045/gsclib045_all_v4_4/gsclib045/timing/fast_vdd1v2_basicCells.lib} /
...
if {$_slk_ != "388.9"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 388.9,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "1264"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 1264,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
